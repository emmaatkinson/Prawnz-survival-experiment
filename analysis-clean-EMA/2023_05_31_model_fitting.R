...
d_low_small = newdat2[newdat2$length==24 & newdat2$temp==10.5,]
d_med_small = newdat2[newdat2$length==24 & newdat2$temp==14.5,]
d_high_small = newdat2[newdat2$length==24 & newdat2$temp==18.5,]
d_vhigh_small = newdat2[newdat2$length==24 & newdat2$temp==23.5,]


plot(d$treatment, d$alive_prob, type="l", ylim=c(0,1), col="white", bty="n")
...
###plot survival by temperature

d=newdat2[newdat2$length==35,]

plot(d[d$treatment==0,]$temp, d[d$treatment==0,]$alive_prob, type="l",ylim=c(0,1), col="white", bty="n")
polygon(c(d[d$treatment==0,]$temp, rev(d[d$treatment==0,]$temp)), c(d[d$treatment==0,]$phi_prob, rev(d[d$treatment==0,]$plo_prob)), col=alpha("black",.25), border=NA)
lines(d[d$treatment==0,]$temp, d[d$treatment==0,]$alive_prob)

polygon(c(d[d$treatment==30,]$temp, rev(d[d$treatment==30,]$temp)), c(d[d$treatment==30,]$phi_prob, rev(d[d$treatment==30,]$plo_prob)), col=alpha("black",.25), border=NA)
lines(d[d$treatment==30,]$temp, d[d$treatment==30,]$alive_prob)

polygon(c(d[d$treatment==60,]$temp, rev(d[d$treatment==60,]$temp)), c(d[d$treatment==60,]$phi_prob, rev(d[d$treatment==60,]$plo_prob)), col=alpha("black",.25), border=NA)
lines(d[d$treatment==60,]$temp, d[d$treatment==60,]$alive_prob)

polygon(c(d[d$treatment==90,]$temp, rev(d[d$treatment==90,]$temp)), c(d[d$treatment==90,]$phi_prob, rev(d[d$treatment==90,]$plo_prob)), col=alpha("black",.25), border=NA)
lines(d[d$treatment==90,]$temp, d[d$treatment==90,]$alive_prob)

polygon(c(d[d$treatment==120,]$temp, rev(d[d$treatment==120,]$temp)), c(d[d$treatment==120,]$phi_prob, rev(d[d$treatment==120,]$plo_prob)), col=alpha("black",.25), border=NA)
lines(d[d$treatment==120,]$temp, d[d$treatment==120,]$alive_prob)


plot_mod = function(size, temp, data){
  d1
