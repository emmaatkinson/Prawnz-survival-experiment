...
# Description: Prawn survival experiment (figures)
# Notes: This code generates the figures associated with the paper "XXX" by 
...
################################################################################
#   
#   Part one: Trial summary figures
#
################################################################################
...
#at the start
trial_df[,"Percent lost"]<-round((100*lost_prawnz/pulled),1)
trial_df[,"Percent dead"]<-round(100*trial_df$Dead/trial_df$Remain,1)
trial_df[,"Percent alive"]<-round(100*trial_df$Alive/trial_df$Remain,1)
trial_df["Percent scavenged"]<-round(100*trial_df$Scavenged/trial_df$Remain,1)
...
################################################################################
#   
#   Part two: Trial summary figures
#
################################################################################
